...
const MyApplications = () => {
  ...
  useEffect(() => {
    dispatch(fetchJobSeekerApplication()); ///************** */
  }, []); // ye tab run krega jab hmara page refresh hoga
  ...
  ///ab apni application hai to us application ko to delete bhi kr shakte hai
